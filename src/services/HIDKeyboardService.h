#ifndef MBED_BLE_HID_SERVICES_HID_KEYBOARD_SERVICE_H_
#define MBED_BLE_HID_SERVICES_HID_KEYBOARD_SERVICE_H_
...
#endif // MBED_BLE_HID_SERVICES_HID_KEYBOARD_SERVICE_H_
